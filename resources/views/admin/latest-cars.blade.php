...
@section('content')
      ...
      <div class="card-body">
        @if($cars->isEmpty())
          <div class="text-center py-5">
            ...
            <p class="text-muted">No latest cars found. Add your first car!</p>
          </div>
        @else
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="btn-group" role="group">
                        ...
                        <form action="{{ route('admin.latest-cars.destroy', $car->id) }}" method="POST" class="d-inline">
                          @csrf
                          @method('DELETE')
                  ...
                  <div class="modal fade" id="editCarModal{{ $car->id }}" tabindex="-1">
                    <div class="modal-dialog">
                      <div class="modal-content">
                        <form action="{{ route('admin.latest-cars.update', $car->id) }}" method="POST"
                          ...
                          <div class="modal-body">
                            ...
                            <div class="row">
                              ...
                              <div class="col-md-6 mb-3">
                                ...
                                <textarea name="features" class="form-control" rows="3">{{ $car->features }}</textarea>
                              </div>
                            </div>
                            <div class="mb-3">
  ...
  <div class="modal fade" id="addCarModal" tabindex="-1">
    <div class="modal-dialog">
      <div class="modal-content">
        <form action="{{ route('admin.latest-cars.store') }}" method="POST" enctype="multipart/form-data">
          @csrf
          <div class="modal-header">
          ...
          <div class="modal-body">
            ...
            <div class="row">
              ...
              <div class="col-md-6 mb-3">
                <label>Features</label>
                <textarea name="features" class="form-control" rows="3" placeholder="Enter car features"></textarea>
              </div>
            </div>
            <div class="mb-3">
              <label>Image *</label>
