        ...
        <form action="{{ route('admin.header.update') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="col-md-6">
              <div class="mb-3">
                ...
                <small class="text-muted">
                  Upload logo image (Recommended: 200x60px)
                </small>
              </div>
            </div>
          ...
          <div class="mb-3">
            ...
            <div id="menu-items-container">
              @if($header && is_array($header->menu_items))
  ...
  @push('scripts')
    <script>
      ...
      document.getElementById('add-menu-item').addEventListener('click', function () {
        ...
        row.className = 'row mb-2 menu-item';
        row.innerHTML = `
                    <div class="col-md-5">
                        <input type="text"
                               name="menu_items[${menuItemIndex}][name]"
                               class="form-control"
                    ...
                    <div class="col-md-5">
                        <input type="text"
                               name="menu_items[${menuItemIndex}][url]"
                               class="form-control"
                               placeholder="URL">
                    </div>
                    ...
                    <div class="col-md-2">
                        <button type="button"
                                class="btn btn-danger btn-sm remove-menu-item">
                            <i class="fas fa-trash"></i>
                        </button>
                    </div>
                `;
